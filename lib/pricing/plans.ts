...
export const pricingPlans: PricingPlan[] = [
  ...
  },
  {
    ...
    features: {
      el: [
        ...
        'AI περίληψη & προσχέδιο άρθρου',
        'Επίσημα πρακτικά & δελτία τύπου',
        'Χωρίς watermark',
      ],
      en: [
        ...
        'AI summary & article draft',
        'Official minutes & press releases',
        'No watermark',
      ],
    },
  ...
  },
  {
    ...
    features: {
      el: [
        'Ό,τι περιλαμβάνει το Creator, συν:',
        'Κοινό workspace για την ομάδα (σύντομα)',
        'Δικαιώματα & ρόλοι (σύντομα)',
        'Συνεργασία σε μεταγραφές (σύντομα)',
        'Ειδικές ρυθμίσεις ασφαλείας (σύντομα)',
        'Priority support',
      ],
      en: [
        'Everything in Creator, plus:',
        'Shared team workspace (soon)',
        'Permissions & roles (soon)',
        'Collaboration on transcripts (soon)',
        'Custom security settings (soon)',
        'Priority support',
      ],
    },
