        ...
        <div className="relative max-w-6xl mx-auto px-6 py-20">
          ...
          <div className="flex flex-col sm:flex-row gap-4 animate-in fade-in slide-in-from-bottom-8 duration-700">
            <button
              ...
              className="cursor-pointer flex items-center w-fit md:w-auto mx-auto md:mx-0 gap-3 px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white text-lg font-semibold rounded-xl transition-all hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/50"
            >
